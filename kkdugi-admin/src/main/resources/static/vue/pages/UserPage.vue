<template><div class="user-page" :inert="loading||actionBusy||undefined">
 <div class="page-heading"><div><div class="eyebrow">SYSTEM MANAGEMENT <span class="eyebrow-line"></span> ADUSER</div><h1 tabindex="-1">{{title||t('aduser')}}</h1><p>{{remarks||t('user_desc')}}</p></div><div class="heading-icon"><i aria-hidden="true" class="las la-users"></i></div></div>

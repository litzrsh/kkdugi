-- V10이 만든 기본 메뉴 트리에 일본어(jp_JA) 메뉴명을 추가한다.
...
-- ko_KR 이름('시스템관리')으로 찾는다. 이미 jp_JA 행이 있으면 건드리지 않는다.
INSERT INTO kkdugi_menu_lang (menu_id, lang_cd, menu_nm, reg_id)
SELECT b.menu_id, 'jp_JA', d.menu_nm, 'SYSTEM'
...
INSERT INTO kkdugi_menu_lang (menu_id, lang_cd, menu_nm, reg_id)
SELECT b.menu_id, 'jp_JA', 'システム管理', 'SYSTEM'
FROM kkdugi_menu_base b
